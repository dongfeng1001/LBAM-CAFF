...
from ultralytics.nn.extra_modules.EMA_attention import EMA_attention
from ultralytics.nn.extra_modules.LSKA import C2f_LSKA_Attention,LSKA_Attention,LSKA
from ultralytics.nn.extra_modules.transformer import *

from ultralytics.nn.nn_improve_df.bifpn import Concat_BiFPN,BiFPN_Concat3,BiFPN_Concat2
from ultralytics.nn.nn_improve_df.attention_mechanism.CoordAtt import CoordAtt
from ultralytics.nn.nn_improve_df.feature_fusion_module.SDI import SDI
...
def torch_safe_load(weight):
    ...
    try:
        with temporary_modules({
            ...
            # return torch.load(file, map_location='cpu'), file  # load   未修改前
...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 C3_Parc, C2f_Parc, C3_DWR, C2f_DWR,PConv,C2f_LSKA_Attention,LSKA_Attention,LSKA):
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
            ...
            c2 = m.channel
                   ...
                   EffectiveSEModule, LSKA, SegNext_Attention, DAttention,EMA_attention,DySample}:
            c2 = ch[f]
            args = [c2, *args]
            # print(args)
            ...
            c2 = ch[f[1]]
            args = [c2, *args]
        elif m in {ContextGuideFusionModule,ContextGuideFusionModuleImprove}:
            c1 = [ch[x] for x in f]
            c2 = 2 * c1[1]
            args = [c1]
        elif m is SDI:
